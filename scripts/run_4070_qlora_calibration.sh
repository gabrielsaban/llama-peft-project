...
TMP_CONFIG="${TMP_BASE}/configs/llama3_3b_qlora_domain_calibration.4070.tmp.yaml"
TMP_OUTPUT_DIR="${TMP_BASE}/outputs/llama3_3b_qlora_domain_calibration"
...
echo "[info] starting QLoRA calibration on 4070"
